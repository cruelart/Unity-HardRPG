...
public class EquipmentItemInstance
{
    ...
    //몬스터 드랍 용도
    public EquipmentItemInstance(EquipmentItemDB _EDB, ItemRawData _raw)
    {
        this.settings = _EDB;
        this.data = _raw;
    ...
    public EquipmentItemInstance(EquipmentItemDB _EDB, ItemRawData _raw, int _durability)
    {
        this.settings = _EDB;
        this.data = _raw;
    ...
    {
        Stat baseStat = data.stats.Find(stat => stat.type == _type);
